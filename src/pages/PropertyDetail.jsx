          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                ...
                {/* Boton favorito */}
                {user && !isOwner && (
                  <button onClick={toggleFav} className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border transition-all mb-2 ${fav ? 'bg-red-50 border-red-200 text-red-600' : 'bg-gray-50 border-gray-200 text-gray-600 hover:border-gray-300'}`}>
                    <svg className="w-4 h-4" fill={fav ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
                ...
                <div className="space-y-3">
                  {whatsappUrl ? (
                    ...
                    }} className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-green-600/20">
                  ...
                  <button onClick={() => onContractClick(property)} className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-brand-600 hover:bg-brand-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-brand-500/20">
              ...
              <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
                ...
                <div className="flex gap-2">
                  <a href={`https://wa.me/?text=${encodeURIComponent(`Mira este arriendo: ${property.titulo} en ${property.comuna} por ${formatPrice(property.precio)}/mes - https://arriendaya.vercel.app/propiedad/${property.id}`)}`} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg text-xs font-medium transition-colors">
                  ...
                  <button onClick={() => { navigator.clipboard.writeText(`https://arriendaya.vercel.app/propiedad/${property.id}`); showToast('Link copiado!', 'success') }} className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-lg text-xs font-medium transition-colors">
