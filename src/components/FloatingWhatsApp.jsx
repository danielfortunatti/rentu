...
export default function FloatingWhatsApp() {
  ...
  const message = 'Hola, tengo una consulta sobre Rentu'
    ...
    <div className="fixed bottom-6 right-6 z-40">
      {showTooltip && (
        <div className="absolute bottom-16 right-0 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-3 w-48 animate-fadeIn">
          ...
          <p className="text-[10px] text-gray-400 mt-0.5">Escríbenos por WhatsApp</p>
      ...
      <a
        ...
        className="group flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-all hover:scale-110 active:scale-95"
